...
func TestExampleFunctions(t *testing.T) {
	...
	t.Run("sieve", func(t *testing.T) {
		...
		testutil.UploadFixtureFunction(t, baseURL, filepath.Join(fixturesDir, "sieve-of-eratosthenes"), fnName, "nodejs", 1, nil)
	...
	t.Run("echo-py", func(t *testing.T) {
		...
		testutil.CleanupDeleteFunction(t, baseURL, fnName)
		testutil.UploadFixtureFunction(t, baseURL, filepath.Join(fixturesDir, "echo-py"), fnName, "python3", 1, nil)
	...
	t.Run("echo-js", func(t *testing.T) {
		...
		testutil.CleanupDeleteFunction(t, baseURL, fnName)
		testutil.UploadFixtureFunction(t, baseURL, filepath.Join(fixturesDir, "echo-js"), fnName, "nodejs", 1, nil)
	...
	t.Run("echo-go", func(t *testing.T) {
		...
		testutil.CleanupDeleteFunction(t, baseURL, fnName)
		testutil.UploadFixtureFunction(t, baseURL, filepath.Join(fixturesDir, "echo-go"), fnName, "go", 1, nil)
	...
	t.Run("echo-binary", func(t *testing.T) {
		...
		testutil.CleanupDeleteFunction(t, baseURL, fnName)
		testutil.UploadFixtureFunction(t, baseURL, filepath.Join(fixturesDir, "echo-binary"), fnName, "binary", 1, nil)
	...
	t.Run("show-headers-js", func(t *testing.T) {
		...
		testutil.CleanupDeleteFunction(t, baseURL, fnName)
		testutil.UploadFixtureFunction(t, baseURL, filepath.Join(fixturesDir, "show-headers-js"), fnName, "nodejs", 1, nil)
	...
	t.Run("show-headers-py", func(t *testing.T) {
		...
		testutil.CleanupDeleteFunction(t, baseURL, fnName)
		testutil.UploadFixtureFunction(t, baseURL, filepath.Join(fixturesDir, "show-headers"), fnName, "python3", 1, nil)
